...
function onDragMove(e) {
  ...
  if (dragState.element) {
    if (!dragState.element.isConnected) {
      console.warn('DRAG: element er ikke i DOM! render() blev kaldt under drag.');
    }
    console.log(`DRAG: zoom=${zoom.toFixed(3)}, dx=${dx.toFixed(1)}, newX=${newX.toFixed(1)}, startX=${dragState.startItemX.toFixed(1)}`);
